...
myprogram(Students) :- =(Students,
			...
			next_to([jacob,_,_,_,_],[P1,_,_,_,_],Students),			% 13. Jacob and Olivia are not neighbours in the waiting list
			(P1 \= olivia),		
			...
			next_to([olivia,_,_,_,_],[emma,_,_,_,_],Students),		% 19. Olivia stands between Emma and Ethan
			next_to([olivia,_,_,_,_],[ethan,_,_,_,_],Students),
